        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10 w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center pt-20 pb-8">
          ...
          <div className="text-center md:text-left">
            ...
            >
              AI that works
              <br />
              <span style={{ color: "#6699FF" }}>without the internet.</span>
            </motion.h1>
            ...
            >
              LocalOS runs entirely on your machine. Disconnect the cable and keep working.
              Chat with models, write code, and build apps without sending a single byte to the cloud.
            </motion.p>
            ...
            >
              ...
              <button
                ...
                onMouseLeave={(e) => (e.currentTarget.style.background = "rgba(0,82,255,0.15)")}
...
const MODEL_LOGOS = [
  ...
  { src: "/logo-qwen.png",      alt: "Qwen by Alibaba Cloud",  label: "Qwen by Alibaba Cloud",  scale: 1.0 },
  { src: "/logo-microsoft.png", alt: "Phi by Microsoft", label: "Phi by Microsoft", scale: 1.0 },
  { src: "/logo-hermes.png",    alt: "Hermes Agent by Nous Research",  label: "Hermes Agent by Nous Research",  scale: 1.15 },
];
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-5 md:px-10">
        <Reveal>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              className="px-8 py-4 rounded-xl font-bold text-base transition-all"
              style={{ background: "rgba(0,82,255,0.18)", border: "2px solid rgba(0,82,255,0.45)", color: "#a0c0ff" }}
              onMouseEnter={(e) => (e.currentTarget.style.background = "rgba(0,82,255,0.32)")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          <div className="md:col-span-1 flex flex-col gap-6">
            ...
            <div className="flex gap-3">
              {[
                { icon: <IconX />, label: "X", href: "https://x.com/localos_xyz" },
                { icon: <IconGitHub />, label: "GitHub", href: "https://github.com/localos-dev" },
              ].map(({ icon, label, href }) => (
                <a
                  key={label}
                  href={href}
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ borderRadius: "16px", overflow: "hidden", border: "1px solid rgba(0,82,255,0.25)", boxShadow: "0 0 80px rgba(0,82,255,0.18)" }}
      >
        <div className="flex items-center justify-between px-4 py-3" style={{ background: "#070D1F", borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
          <span className="text-sm font-semibold text-white">See how LocalOS works</span>
          <button
            onClick={onClose}
